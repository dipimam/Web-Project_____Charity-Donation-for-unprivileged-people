...
<html lang="en" dir="ltr">
  ...
  <body>
   ...
   <div class="w3-sidebar w3-bar-block w3-light-grey" style="width:25%">
     ...
     <a href="Registration.php" class="w3-bar-item w3-button">Add Admin</a><br>
     <a href="reportNotification.php" class="w3-bar-item w3-button">Report Notification</a><br>
     <a href="donationNotification.php" class="w3-bar-item w3-button">Donation Notification</a><br>
       <a href="liveSearch.php" class="w3-bar-item w3-button">Search Volunteer</a><br>
...
?>
     ...
     <div class="noti">
         <p><?php echo $report['USERNAME'] ?> packed <?php echo $report['PACKING'] ?> packet foods and donated	<?php echo $report['PACKET'] ?> pack foods in <?php echo $report['AREA'] ?></p>
